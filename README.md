...
> canonical store **56,399 kayıt** (person 22,935 · place 19,929 · work 9,331 ·
> institution 3,918 · dynasty 186 · event 100 — koddan sayılır, `make reindex-dry`
> özetiyle doğrulanır);
...
| **Canonical store** | 56,399 kayıt (gitignored; `data/sources/` + adapter replay'den yeniden üretilebilir). |
...
| **Search artifacts** | `typesense_collection.schema.json`, `facets.yaml`, 6 projection rules, `projector.py`; `full_reindex.py --dry-run` = 56,399/56,399 projeksiyon regresyon kapısı. |
