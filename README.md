...
> canonical store **57,177 kayıt** (person 22,935 · place 19,929 · work 9,331 ·
...
| **Canonical store** | 57,177 kayıt (gitignored; `data/sources/` + adapter replay'den yeniden üretilebilir). |
...
| **Search artifacts** | `typesense_collection.schema.json`, `facets.yaml`, 6 projection rules, `projector.py`; `full_reindex.py --dry-run` = 57,177/57,177 projeksiyon regresyon kapısı. |
